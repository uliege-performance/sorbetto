...
class AbstractParameterization ( ABC ) :
    ...
    def locateWeightedAccuracy ( self, priorPos, weightPos ) -> PointInTile :
        return self.locateRankingScore ( RankingScore.getWeightedAccuracy ( priorPos, weightPos )
    ...
    def locateProbabilityFalsePositiveComplenent ( self, priorPos ) -> PointInTile :
        return self.locateRankingScore ( RankingScore.getProbabilityFalsePositiveComplenent () )
    
    def locateProbabilityFalseNegativeComplenent ( self, priorPos ) -> PointInTile :
        return self.locateRankingScore ( RankingScore.getProbabilityFalseNegativeComplenent () )
    ...
    def __str__ ( self ) :
        return 'parameterization "{}"'.format ( getName () )
    ...
    def unitTest ( self ) :
        for trial in range ( 1000 ) :
            ...
            assert isinstance ( rankingScore, RankingScore )
            importance = rankingScore.getImportance ()
            itn = importance.itn ()
            ifp = importance.ifp ()
            ifn = importance.ifn ()
            itp = importance.itp ()
