...
class ParameterizationAdaptedToClassPriors ( AbstractParameterization ) :
    ...
    def _adapt_a_b ( self, old_prior_pos, new_prior_pos, old_a, old_b ) :
        ...
        old_I_tn, old_I_fp, old_I_fn, old_I_tp = self._from_a_b_to_itn_ifp_ifn_itp ( old_a , old_b )
        ...
        new_a, new_b = self._from_itn_ifp_ifn_itp_to_a_b ( new_I_tn, new_I_fp, new_I_fn, new_I_tp )
